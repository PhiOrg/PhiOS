...
ld -m elf_i386 -T link.ld -o ../bin/kernel.elf ../bin/kernel.o ../bin/phi_main.o ../bin/vga.o ../bin/memcpy.o ../bin/common.o ../bin/gdt.o ../bin/idt.o ../bin/isr.o ../bin/a_gdt.o ../bin/a_idt.o ../bin/a_interrupt.o ../bin/interrupts.o
