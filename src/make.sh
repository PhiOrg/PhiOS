gcc -m32 -std=gnu99 -nostdlib -ffreestanding -nostdinc -fno-builtin -fno-stack-protector -c -o ../bin/phi_main.o kernel/phi_main.c -Ilibc/include -Ikernel/include -Ikernel/arch/i386/include
...
ld -m elf_i386 -T linker.ld -o ../bin/kernel.elf ../bin/kernel.o ../bin/phi_main.o ../bin/vga.o ../bin/memcpy.o ../bin/common.o ../bin/gdt.o ../bin/idt.o ../bin/isr.o ../bin/a_gdt.o ../bin/a_idt.o ../bin/a_interrupt.o ../bin/interrupts.o ../bin/irq.o ../bin/keyboard.o ../bin/a20.o
